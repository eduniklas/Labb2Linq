    ...
    public partial class creatingtables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActiveCourses", x => x.ActiveCourseId);
                    table.ForeignKey(
                        name: "FK_ActiveCourses_Courses_FK_CourseId",
                        column: x => x.FK_CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActiveCourses_Students_FK_StudentId",
                        column: x => x.FK_StudentId,
                        principalTable: "Students",
                        principalColumn: "StudentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActiveCourses_Teachers_TeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActiveCourses_FK_CourseId",
                table: "ActiveCourses",
                column: "FK_CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_ActiveCourses_FK_StudentId",
                table: "ActiveCourses",
                column: "FK_StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_ActiveCourses_TeacherId",
                table: "ActiveCourses",
                column: "TeacherId");
        }
